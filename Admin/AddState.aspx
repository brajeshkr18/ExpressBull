<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddState.aspx.cs" Inherits="Shippink_Kart.AddState" %>
                                            ...
                                            <div class="span6 billing-form">
                                                ...
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        State Name</label>
                                                    <asp:TextBox ID="txtState" runat="server" class=" span8"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                        ControlToValidate="txtState" ErrorMessage="Required " ForeColor="Maroon"></asp:RequiredFieldValidator>
                                                </div>
                                            </div>
