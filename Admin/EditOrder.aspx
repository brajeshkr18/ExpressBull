<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="EditOrder.aspx.cs" Inherits="Shippink_Kart.EditOrder" %>
                        ...
                        <ul class="nav pull-right top-menu">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <ul class="dropdown-menu extended logout">
                                    ...
                                    <li>
                                        <asp:Button ID="Button4" runat="server" Text="Log Out" Height="38"
                                            CssClass="btn-block" Style="font-weight: bold;" BorderStyle="None"
                                            BorderWidth="0" OnClick="Button4_Click" /></li>
                                </ul>
                            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <h3 class="page-title">Editable Table
                            </h3>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="invoice-date-range span12 form">
                                            ...
                                            <div class="control-group ">
                                                <label class="control-label span2">
                                                    Order Date</label>
                                                <asp:TextBox ID="txtOrderDate" runat="server" class="m-ctrl-medium span2"></asp:TextBox>
                                                <label class="control-label span2">
                                                    Expected Delivery Date</label>
                                                <asp:TextBox ID="txtExpDelDate" runat="server" class="m-ctrl-medium span2"></asp:TextBox>
                                                <label class="control-label span2">
                                                    Order ID</label>
                                                <asp:TextBox ID="txtOrderID" runat="server" class="m-ctrl-medium span2"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="space15">
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span6 billing-form">
                                                ...
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        State</label>
                                                    <asp:DropDownList ID="drpCustomerState" runat="server" class="span8" AutoPostBack="true"
                                                        OnSelectedIndexChanged="drpCustomerState_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                ...
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Phone</label>
                                                    <asp:TextBox ID="txtCustomerPhone" runat="server" class=" span8"></asp:TextBox>
                                                ...
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Email</label>
                                                    <asp:TextBox ID="txtCustomerEmail" runat="server" class=" span8"></asp:TextBox>
                                            ...
                                            <div class="span6 billing-form ">
                                                ...
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Unit Price</label>
                                                    <asp:TextBox ID="txtItemUnitPrice" runat="server" class=" span6"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                                        ControlToValidate="txtItemUnitPrice" ErrorMessage="Required" ForeColor="Maroon"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Quantity</label>
                                                    <asp:TextBox ID="txtItemQuantity" runat="server" class=" span6" AutoPostBack="True"
                                                        OnTextChanged="txtItemQuantity_TextChanged"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                                        ControlToValidate="txtItemQuantity" ErrorMessage="Required" ForeColor="Maroon"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Total</label>
                                        ...
                                        <div class="row-fluid">
                                            <div style="float: left; padding-right: 10px">
                                                <asp:Button ID="Button1" runat="server" Text="Edit Order" class="btn btn-primary btn-large hidden-print"
                                                    OnClick="Button1_Click" />
                                            </div>
                                            <div style="float: left">
                                                <asp:Button ID="Button2" runat="server" Text="Save Order" class="btn btn-primary btn-large hidden-print"
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Order ID</label>
                                                    <asp:DropDownList ID="drporderid" runat="server" class="span6" Enabled="false">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        State</label>
                                                    <asp:DropDownList ID="drpstate" runat="server" class="span6" AutoPostBack="true"
                                            ...
                                            <div class="span6">
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        City</label>
                                                    <asp:DropDownList ID="drpcity" runat="server" class="span6">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="control-group ">
                                                    <label class="control-label">
                                                        Status</label>
                                                    <asp:DropDownList ID="drporderstatus" runat="server" class="span6" AutoPostBack="false">
                                                        <asp:ListItem>Processing</asp:ListItem>
                                                        <asp:ListItem>Delivered</asp:ListItem>
                                                        <asp:ListItem></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <asp:Button ID="Button3" runat="server" Text="Submit" class="btn btn-primary btn-large hidden-print"
