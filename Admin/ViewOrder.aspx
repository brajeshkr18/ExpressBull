<%@ Page Language="C#" AutoEventWireup="true" enableEventValidation="false" CodeBehind="ViewOrder.aspx.cs" Inherits="Shippink_Kart.ViewOrder" %>
...
<body class="fixed-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <h3 class="page-title">Order Detail
                            </h3>
                            <ul class="breadcrumb">
                                <li><a href="#">Home</a> <span class="divider">/</span> </li>
                                <li>View Order <span class="divider">/</span> </li>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget purple">
                                <div class="widget-title">
                                    <h4>
                                        <i class="icon-reorder">&nbsp;</i>Order Detail</h4>
                                ...
                                <div class="widget-body">
                                    <div>
                                        ...
                                        <div class="clearfix">
                                            <div class="btn-group">
                                                <button id="editable-sample_new" class="btn green">
                                                    <a href="CreateOrder.aspx">New<i class="icon-plus"></i></a>
                                                </button>
                                            </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="col-sm-12">
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                                    CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" Style="overflow: auto; text-align: center">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="CustomerPhone" DataField="CustomerPhone" SortExpression="CustomerPhone" />
                                                        <asp:BoundField HeaderText="CustomerEmail" DataField="CustomerEmail" SortExpression="CustomerEmail" />
                                                        <asp:BoundField HeaderText="ItemName" DataField="ItemName" SortExpression="ItemName" />
                                                        <asp:BoundField HeaderText="ItemDescription" DataField="ItemDescription" SortExpression="ItemDescription" />
                                                        <%--<asp:CommandField ShowSelectButton="True"  HeaderText="Action" SelectText="Send Mail" ControlStyle-ForeColor="Navy" />--%>
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:expressConnectionString %>" SelectCommand="SELECT DISTINCT [OrderID], [CustomerName], [CustomerAddress], [CustomerPhone], [CustomerEmail], [ItemName], [ItemDescription], [OrderStatus] FROM [OrderDetail] WHERE ([Status] = @Status)">
                                                    <SelectParameters>
                                        ...
                                        <asp:Label ID="Label1" runat="server" Visible="false"></asp:Label><asp:Label ID="Label2" runat="server" Visible="false"></asp:Label>
    ...
    <script>
        ...
        function editable-sample_new_onclick() {
